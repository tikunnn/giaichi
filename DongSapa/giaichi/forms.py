...
class GiaichiForm(forms.ModelForm):
    ...
    # def __init__(self, *args, **kwargs):
    #     super().__init__(*args, **kwargs)
    #     self.fields['tieude'].widget.attrs.update(
    #         {'placeholder': 'Nhập tiêu đề'})
    #     self.fields['ghichu'].widget.attrs.update(
    #         {'placeholder': 'Nhập ghi chú'})
    #     self.fields['noidungmota'].widget.attrs.update(
    #         {'placeholder': 'Mô tả nội dung giải chi'})
    #     self.fields['motathanhtoan'].widget.attrs.update(
