...
class Phongban(models.Model):
    mapb = models.CharField(default='', blank=True, null=True,
                            max_length=255, verbose_name='Mã Phòng Ban')
    tenpb = models.CharField(default='', unique=True,
                             max_length=255, verbose_name='Tên Phòng Ban')
    ngaythanhlap = models.DateTimeField(
        verbose_name='Năm thành lập', null=True)
...
class Nhanvien(models.Model):
    manv = models.CharField(default='', unique=True,
                            max_length=255, verbose_name='Mã Nhân Viên')
    username = models.ForeignKey(
        User, on_delete=models.CASCADE, verbose_name='Tài Khoản Nhân Viên')
    tennv = models.CharField(default='', max_length=255,
                             verbose_name='Họ Tên Nhân Viên')
...
class Cong_trinh_da(models.Model):
    ...
    truongteam = models.ForeignKey(Nhanvien, on_delete=models.SET_NULL,
                                   null=True, blank=True, related_name='truongteam_congtrinh')
    kinhdoanh = models.ForeignKey(Nhanvien, on_delete=models.SET_NULL,
                                  null=True, blank=True, related_name='kinhdoanh_congtrinh')
    ...
    tinhtrang = models.CharField(
        default='KHOI_TAO', max_length=255, null=True, blank=True, choices=TINHTRANG_CHOICES)
...
class Giaichi(models.Model):
    ...
    phongban = models.ForeignKey(
        Phongban, on_delete=models.CASCADE, related_name="related_primary_giaichi")
    ...
    noidungmota = RichTextUploadingField(null=True, blank=True)
    ...
    trangthaiduyet_admin = models.BooleanField(
        default=False, blank=False, null=False)
    trangthaiduyet_kinhdoanh = models.BooleanField(
        default=False, blank=False, null=False)
    trangthaiduyet_pp = models.BooleanField(
    ...
    hinhthucthanhtoan = models.CharField(
        max_length=20, null=True, blank=True, choices=PAYMENT_METHOD_CHOICES, verbose_name='Hình Thức Thanh Toán')
    motathanhtoan = models.CharField(
        default="", blank=True, null=True, max_length=2255)
    macheck = models.CharField(
        default="", blank=True, null=True, max_length=2255)
    ...
    trangthaiduyet_dsp = models.BooleanField(
        default=False, blank=False, null=False)
    trangthaiduyet_khac = models.BooleanField(
        default=False, blank=False, null=False)
    checkgiaichigiaonhan = models.BooleanField(
        default=False, blank=False, null=False)
    checkgiaichiduan = models.BooleanField(
        default=False, blank=False, null=False)
    giaichithuoc = models.CharField(
        max_length=20, null=True, blank=True, choices=GIAICHITHUOC_CHOICES, verbose_name='Hàng Hóa Thuộc')
    ...
    thuocvecongty = models.ForeignKey(
        Phongban, on_delete=models.CASCADE, related_name="related_secondary_giaichi", null=True, blank=True)
    check_chuyen_giaingan = models.BooleanField(
        default=False, null=True, blank=True)
    tkno = models.CharField(blank=True, null=True,
                            max_length=200, verbose_name=' TK Nợ')
    ytno = models.CharField(blank=True, null=True,
                            max_length=200,  verbose_name=' YT Nợ')
    tkco = models.CharField(blank=True, null=True,
                            max_length=200, verbose_name=' TK Có')
    ytco = models.CharField(blank=True, null=True,
                            max_length=200,  verbose_name=' YT Có')
    ...
    thongbao_duyet_pp = models.BooleanField(
        default=False, null=True, blank=True)
    thongbao_duyet_tp = models.BooleanField(
        default=False, null=True, blank=True)
    thongbao_duyet_sep = models.BooleanField(
        default=False, null=True, blank=True)
    thongbao_duyet_ht = models.BooleanField(
        default=False, null=True, blank=True)
    thongbao_duyet_huy = models.BooleanField(
        default=False, null=True, blank=True)
    history = HistoricalRecords()
